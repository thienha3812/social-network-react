...
import { loadRequestService, acceptFriendRequest } from '../services/user.service';
...
function Navbar(props) {
  ...
  const acceptFriend = async (id,indexInArray) =>{
    ...
    if(request.data.success){
      let currentList = list.slice(0,indexInArray) + list.slice(indexInArray+1)      
      setList([...currentList])
    }    
  }
        ...
        <nav className="navbar navbar-expand-lg navbar-light p-0">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto navbar-list">
              <li>
                <a href="#" className="iq-waves-effect d-flex align-items-center">
                  <img src={props.state.signinReducer.avatar} className="img-fluid rounded-circle mr-3" alt="user" />
                  <div className="caption">
                    <h6 className="mb-0 line-height">{props.state.signinReducer.full_name}</h6>
                  </div>
                </a>
              </li>
              <li>
                <a href="/bangtin" className="iq-waves-effect d-flex align-items-center">
                  <i className="ri-home-line" />
                </a>
              </li>
              <ClickAwayListener onClickAway={closeFriendRequest}>
                <li className="nav-item " ref={refFriendRequest} >
                  <a className="search-toggle iq-waves-effect" onClick={openFriendRequest} href="javascript:void(0)"><i className="ri-group-line" /></a>
                      ...
                      <div className="iq-card-body p-0 ">
                        <div className="bg-primary p-3">
                          <h5 className="mb-0 text-white">
                            Kết bạn
  <small className="badge  badge-light float-right pt-1">{list.length}</small>
                          </h5>
                        </div>
                              ...
                              <div className="iq-friend-request">
                                <div className="iq-sub-card iq-sub-card-big d-flex align-items-center justify-content-between">
                                  <div className="d-flex align-items-center">
                                    <div className>
                                      <img className="avatar-40 rounded" src={x.avatar} alt="" />
                                    </div>
                                    <div className=" ml-3">
                                      <a href={"/nguoidung?id="+x.id} className="mb-0 ">{x.full_name}</a>
                                      <p className="mb-0">40  friends</p>
                                    </div>
                                  </div>
                                  <div className="d-flex align-items-center">
                                    <button onClick={()=>acceptFriend(x.id,i)} className="mr-3 btn btn-primary rounded">Xác nhận</button>
                                    <a href="javascript:void();" className="mr-3 btn btn-secondary rounded">Huỷ</a>
                                  </div>
                                </div>
                              </div>
                            </>) : <div className="text-center">Bạn chưa có lời mời kết bạn nào!</div>
                        }
                        <div className="text-center">
                          <a href="#" className="mr-3 btn text-primary">Xem thêm</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <ul className="navbar-list">
              <ClickAwayListener onClickAway={closeNavbarList}>
                <li ref={refNavBarList}>
                  <IconButton aria-label="delete" onClick={openNavbarList} style={{ color: '#50b5ff' }}>
                    <ExpandMoreIcon />
                  </IconButton>
                    ...
                    <div className="iq-card shadow-none m-0">
                      <div className="iq-card-body p-0 ">
                        ...
                        <div className="d-inline-block w-100 text-center p-3">
                          <a className="bg-primary iq-sign-btn text-white" href="javascript:void(0)" onClick={() => props.handleLogout()} role="button">
                            Đăng xuất
