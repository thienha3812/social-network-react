                      ...
                      <div className="modal-body">
                        ...
                        <ul className="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                          ...
                          <li className="col-md-6 mb-3">
                            <div className="iq-bg-primary rounded p-2 pointer mr-3">
                              <a href="#" />
                              <img src="images/small/10.png" alt="icon" className="img-fluid" />
                              {' '}
                              Check in
                            </div>
                          </li>
                          <li className="col-md-6 mb-3">
                            <div className="iq-bg-primary rounded p-2 pointer mr-3">
                              <a href="#" />
                              <img src="images/small/11.png" alt="icon" className="img-fluid" />
                              {' '}
                              Live Video
                            </div>
                          </li>
                          <li className="col-md-6 mb-3">
                            <div className="iq-bg-primary rounded p-2 pointer mr-3">
                              <a href="#" />
                              <img src="images/small/12.png" alt="icon" className="img-fluid" />
                              {' '}
                              Gif
                            </div>
                          </li>
                          <li className="col-md-6 mb-3">
                            <div className="iq-bg-primary rounded p-2 pointer mr-3">
                              <a href="#" />
                              <img src="images/small/13.png" alt="icon" className="img-fluid" />
                              {' '}
                              Watch Party
                            </div>
                          </li>
                          <li className="col-md-6 mb-3">
                            <div className="iq-bg-primary rounded p-2 pointer mr-3">
                              <a href="#" />
                              <img src="images/small/14.png" alt="icon" className="img-fluid" />
                              {' '}
                              Play with Friends
                            </div>
                          </li>
